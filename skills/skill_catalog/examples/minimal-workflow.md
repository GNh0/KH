# UAF Skill Catalog Minimal Workflow Example

## Scenario

A host agent receives a task where this trigger is relevant: Use when listing, reading, or adding packaged UAF skills and harnesses in this repository.

The agent must decide whether `skill-catalog` applies, run or apply it according to its execution level, and leave auditable evidence.
