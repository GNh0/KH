...
A host agent receives a task where this trigger is relevant: Use when terminal logs, command output, or Python code are too large for efficient LLM context handling.
