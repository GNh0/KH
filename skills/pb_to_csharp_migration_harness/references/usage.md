...
- Migration analysis `.md` quality result: required section coverage, evidence-anchor coverage, implementation-readiness coverage, telemetry counts for review only, and blocked reason when the handoff is not implementation-ready.
