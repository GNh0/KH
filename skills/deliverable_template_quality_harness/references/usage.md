# Deliverable Template Quality Harness Usage Reference

This reference expands the portable operating contract for `deliverable-template-quality-harness`. Read it when the task is real work, when deciding whether this skill applies, or when a review needs evidence beyond the concise `SKILL.md`.

## When to use

Use when UAF-generated user deliverables need template completeness, required section coverage, or evidence-backed quality checks.

Context summary: This harness checks user-facing deliverables against recognizable document and spreadsheet templates. It is for quality evidence, not for creating extra user documents about UAF internals.
...
2. Read this reference before performing non-trivial work with `deliverable-template-quality-harness`.
...
A valid use of `deliverable-template-quality-harness` must leave enough evidence for another agent to answer: why this skill applied, what ran or was applied, what changed, and what still needs attention.
