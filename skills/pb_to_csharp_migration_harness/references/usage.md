...
7. Before C# generation, write a substantial migration analysis `.md` handoff and verify it with `verify_pb_migration_analysis_document`. The 019f178e PR100200/PROD_302_A document depth is the minimum accepted floor, not an optional rich example. A short log, rough bullet list, or shallow objective/scope note is blocked.
...
- Migration analysis `.md` quality result: line count, heading count, code fence count, required section coverage, and blocked reason when below the 019f178e minimum floor.
