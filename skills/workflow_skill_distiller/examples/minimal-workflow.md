# Workflow Skill Distiller Minimal Workflow Example

## Scenario

A host agent receives a task where this trigger is relevant: Use when turning a repeated user workflow, completed interaction, or project-specific process into a reusable UAF skill folder.

The agent must decide whether `workflow-skill-distiller` applies, run or apply it according to its execution level, and leave auditable evidence.
