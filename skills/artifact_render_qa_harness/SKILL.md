...
description: Use when UAF deliverables must prove generated documents, spreadsheets, drawings, images, web pages, data exports, or other typed files are readable and pass format-specific structural or sanity checks.
---
