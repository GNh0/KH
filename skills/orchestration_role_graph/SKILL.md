...
This is the UAF-native role contract for multi-agent orchestration. It makes leadership, advisory, design, implementation, review, verification, and release responsibilities explicit instead of leaving them as prompt-only assumptions.
...
- Parallel file workers currently execute as `implementer`; review roles are represented as gates in the role graph and can be wired to concrete agent runtimes later.
