...
- `src.orchestration.session_start_context.build_session_start_context(...)` inspects `.kh`, `docs/kh`, scoped memory candidates, and objective-ranked `memory_recall` at the start of the next session.
