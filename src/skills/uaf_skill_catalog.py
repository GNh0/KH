...
SKILL_EXECUTION_LEVELS = {
    ...
    "single-file-generator": "python-module",
    "skill-catalog": "python-module",
    "snippet-library": "python-module",
