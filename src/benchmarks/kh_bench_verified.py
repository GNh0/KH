...
_TASKS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "problem_statement": "Create product-design deliverables from a compact spec and validate each typed output with format-specific structure checks.",
        "base_workspace": {"files": []},
    ...
    },
    {
        ...
        "human_verified": True,
        "skills": ["domain-orchestration-harness", "artifact-render-qa-harness", "deliverable-template-quality-harness"],
        "problem_statement": "SIDE regression: compact product specs such as 200x120, SUS304, and four M20 holes must flow into type-appropriate design, table, drawing, and handoff deliverables.",
        "base_workspace": {"files": []},
