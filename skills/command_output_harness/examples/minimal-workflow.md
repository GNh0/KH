...
4. Call `src.skills.token_optimizer.summarize_command_output` for command output evidence.
5. Write or report the resulting compact stdout/stderr, exit code, size metadata, or fallback reason.
