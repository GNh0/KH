# Deliverable Template Quality Harness Minimal Workflow Example

## Scenario

A host agent receives a task where this trigger is relevant: Use when UAF-generated user deliverables need template completeness, required section coverage, or evidence-backed quality checks.

The agent must decide whether `deliverable-template-quality-harness` applies, run or apply it according to its execution level, and leave auditable evidence.
...
- `skill`: `deliverable-template-quality-harness`.
